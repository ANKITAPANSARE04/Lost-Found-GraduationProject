...
GO
ALTER TABLE [dbo].[LostT] ALTER COLUMN [FullName] VARCHAR (50) NOT NULL;

ALTER TABLE [dbo].[LostT] ALTER COLUMN [LdateTime] DATETIME2 (7) NOT NULL;


GO
ALTER TABLE [dbo].[LostT]
    ADD [Limg] IMAGE NOT NULL;
